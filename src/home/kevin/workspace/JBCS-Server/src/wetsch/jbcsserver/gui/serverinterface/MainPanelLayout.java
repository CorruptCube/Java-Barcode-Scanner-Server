...
import wetsch.jbcsserver.gui.customuiobjects.SocketPortField;
...
public abstract class MainPanelLayout extends JFrame{
	...
	protected ServerInterfaceMainMenu menuBar = new ServerInterfaceMainMenu();
	...
	private void jpConnectionConfigSetup(){
		...
		jtfPort.setToolTipText("Enter a number between 0 an 65535");
		addComp(jpConnectionConfig, jtfPort, 2, 2, 1, 1, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL, 0, 0);

		addComp(jpConnectionConfig, new JLabel("Back LOg"), 1, 3, 1, 1, GridBagConstraints.FIRST_LINE_END, GridBagConstraints.NONE, 0, 0);
		jtfConnectionLimit.setToolTipText("Set the pending connection liit");
		addComp(jpConnectionConfig, jtfConnectionLimit, 2, 3, 1, 1, GridBagConstraints.FIRST_LINE_START, GridBagConstraints.HORIZONTAL, 1, 1);
	}
